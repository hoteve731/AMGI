...
1. 주어진 텍스트에 대한 효과적인 기억을 돕는 5~10개 내외의 '기억 카드'를 만드세요. 텍스트의 분량과 복잡성에 따라 3~15개 내외로 유연하게 조절 가능하며, 핵심 개념을 빠짐없이 다루는 것을 우선시합니다.
...
3. Cloze 기억 카드는 다름 형식을 따릅니다: 
   ...
   - Cloze 기억 카드는 반드시 2개 이상 포함해야 합니다 (단, 텍스트가 매우 짧거나 단일 개념일 경우 1개도 허용)
